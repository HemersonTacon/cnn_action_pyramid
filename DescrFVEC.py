...
def getData(fvec_file, L2=False, power_norm=False, power_exp=0.2, std=False):
	...
	num_videos = len(chunks)/(CintSize + descr_size*CfloatSize) #get the number of videos
	num_videos = int(num_videos)
	print('debug')
	print('O tipo de num_video' + str(type(num_videos)))
	print('O valor de num_video é: ' + str(num_videos))
...
def saveDescriptor(filename, descriptor):
	...
	print("descriptor size: %d" % descr_size)
