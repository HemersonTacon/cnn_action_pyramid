...
def _main(args):
     ...
     pca.write_pca_baseground(arquivo_a_reduzir + "_autovetores", auto_vetores, args.outdir)
     pca.write_pca_baseground(arquivo_a_reduzir + "_vetor_media", media, args.outdir)
