...
def _main(args):
     ...
     pca.write_pca_baseground("autovetores_" + arquivo_a_reduzir, auto_vetores, args.outdir)
     pca.write_pca_baseground("vetor_media_" + arquivo_a_reduzir, media, args.outdir)
